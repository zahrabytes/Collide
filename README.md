...
Users on [Collide](https://collide.io) need recommendations. The goal for this challenege is to **create a recommendation engine** that shows a user posts and content tailored to their role and interests.
